            ...
            {bookingHistory.map((booking, index) => (
                <div key={index} className='flex gap-4 border rounded-lg p-4 mb-5'>
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        <h2 className='flex gap-2  text-gray-500'> <Calendar className='text-primary' /> Service On : 
                        <span className='text-black'> {booking.date} </span></h2>

                        <h2 className='flex gap-2  text-gray-500'> <Clock className='text-primary' /> Service On : 
                        <span className='text-black'> {booking.time} </span></h2>
                    </div>
